...
class report_29Admin(admin.ModelAdmin):
    ...
    #     initial_email = selected_drivers[0] if selected_drivers else ""
    #     initial_car = selected_cars[0] if selected_cars else ""
    #     initial_depot = selected_depots[0] if selected_depots else ""
    #     initial_ref = selected_refs[0] if selected_refs else ""
    #     initial_date = selected_dates[0] if selected_dates else ""
    #     initial_defect = selected_defects[0] if selected_defects else ""

    #     form = UpdateForm(initial={'driver_email': initial_email, 'car': initial_car, 'Depot_feedback': initial_depot, 'ref_number': initial_ref, 'date_of_fault': initial_date, 'defect_details': initial_defect})
    ...
    def send_email_action(self, request, queryset):
        ...
        try:
            ...
            message = 'Your update message goes here.'
